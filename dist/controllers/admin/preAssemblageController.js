...
exports.getAllPreAssemblages = getAllPreAssemblages;
exports.createPreAssemblage = createPreAssemblage;
exports.deletePreAssemblage = deletePreAssemblage;
 ...
 * ]
 */
async function getAllPreAssemblages(req, res) {
    try {
 ...
 * }
 */
async function createPreAssemblage(req, res) {
    try {
 ...
 */
async function deletePreAssemblage(req, res) {
    try {
